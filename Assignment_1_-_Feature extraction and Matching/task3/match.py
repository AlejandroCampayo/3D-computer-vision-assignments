...
def match(descriptors1, descriptors2, device, dist="norm2", threshold=10, ratio=0.8):
    """
    ...
    # sorted_matches = sorted(valid_matches, key=lambda x: distances[x[0].item(), sorted_indices[x[0].item(), 0]])
